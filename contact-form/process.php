...
// Form options
$options['captcha_secret']      = '6LdzHSkTAAAAAHDAhpG2G9lQ9qycghoFCrWxdVpl';                     // Google reCAPTCHA secret key
$options['redirect_url']        = './thanks.html';                                     // URL of custom success page
...
$options['from_address']        = 'info@redresourceuk.com';               // Address the email is sent from
$options['from_name']           = 'Website form COMPLETE - Red Resource UK';                              // Name to attach to the address
$options['to_addresses']        = array( 'info@redresourceuk.com' );               // To: addresse(s), add new array item for more
$options['bcc_addresses']       = array( 'webmaster@redresourceuk.com' );               // BCC: addresse(s), add new array item for more
...
$options['smtp_host']           = 'host36.registrar-servers.com';		  // Specify main and backup SMTP servers
$options['smtp_auth']           = true;                                   // Enable SMTP authentication
$options['smtp_username']       = 'info@redresourceuk.com';               // SMTP username
$options['smtp_password']       = 'v9UC7WW5@!yfT8W';                             // SMTP password
$options['smtp_secure']         = 'ssl';                                  // Enable TLS encryption, `ssl` also accepted
$options['smtp_port']           = 465;                                    // TCP port to connect to
...
/**
 * FUNCTION TO END USER CONFIRMATION EMAIL
 * ==================================================================
 *
 */
