...
BETAPHP FormatterHomeFeaturesContactAbout
Bookmark and Share 
                    ...
                    <div class="form-group">
                      ...
                      <div class="inputGroupContainer">
                        <div class="input-group">
                          ...
                          <input class="form-control" name="first_name" placeholder="First Name" type="text" value="<?php
                  ...
                  <div class="col-xs-5 pull-right">
                    ...
                    <div class="form-group">
                      ...
                      <div class="inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-user"></i></span>
                          <input class="form-control" name="last_name" placeholder="Last Name" type="text" value="<?php
                ...
                <div class="form-group">
                  ...
                  <div class="inputGroupContainer">
                    <div class="input-group">
                      ...
                      <input aria-describedby="inputemailStatus" class="form-control" id="inputemail" name="email" placeholder="j.smith@hotmail.com" type="text" value=" <?php
echo $_POST["email"];
?>">
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="inputGroupContainer">
                    <div class="input-group">
                      ...
                      <input class="form-control" name="phone" placeholder="0161 282 1930" type="text" value="<?php
echo $_POST["phone"];
?>">
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="inputGroupContainer">
                    <div class="input-group">
                      ...
                      <textarea class="form-control" name="comment" placeholder="Write your message here" rows="6" value=" <?php
echo $_POST["comment"];
?>"></textarea>
                    </div>
                  </div>
