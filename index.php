...
<head>
  ...
  <link rel="icon" type="image/png" sizes="194x194" href="/img/touch/favicon-194x194.png?v=1.2">
  ...
  <link href="css/style.min.css?=ver1.12" rel="stylesheet" />
...
<body id="home">
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li><a href="#about">Why do I need a Will?</a>
                    </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="row wow fadeInLeft">
                        <div class="col-md-12 text">
                            <div class="text-inner">
                                <h1>Comfort Estate Planning can write your will for only <strong>£199</strong></h1>
                    ...
                    <div class="row wow fadeInBottom" data-wow-delay="2500">
                        <div class="col-md-12">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-xs-5">
                                        ...
                                        <div class="form-group">
                                            <div class="has-succes">
                                                <div class="checkbox">
                                                    <label>
                                                        <input data-error="Sign up to our mailing list?" id="checkboxSuccess" checked="checked" type="checkbox" value="mailing-list"> I'd like to stay informed! <span>Add me to your mailing-list</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-7 pull-right">
                                        <!-- Button -->
                                        <div class="form-group">
                                            <button class="btn btn-block btn-orange text-light text-hover-light" type="submit">Send your message <span class="fa fa-send"></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row footer">
                <div class="col-xs-12 col-md-2">
                    <p>Comfort Estate Planning. - &copy;opyright <span class="year"></span>
                    </p>
    ...
    <?php if ( $_SERVER[ 'REQUEST_METHOD']=='POST' ) { echo "<script type='text/javascript'>
